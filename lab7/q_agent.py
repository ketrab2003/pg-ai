...
class QAgent(Agent):
    ...
    def __init__(self, n_states, n_actions,
        ...
        # hyperparams
        # DONE - ustaw te parametry na sensowne wartości
        ...
        self.eps_min = 1e-5        # końcowa wartość epsilon, poniżej którego już nie jest zmniejszane (~ 1e−2 − 1e−5)
    ...
    def init_q_table(self, initial_q_value=0.) -> np.ndarray:
        # DONE - utwórz tablicę wartości Q o rozmiarze [n_states, n_actions] wypełnioną początkowo wartościami initial_q_value
        q_table = np.ones((self.n_states, self.n_actions)) * initial_q_value
        return q_table

    def update_action_policy(self) -> None:
        # DONE - zaktualizuj wartość epsilon
    ...
    def choose_action(self, state: State) -> Action:
        ...
        # DONE - zaimplementuj strategię eps-zachłanną
