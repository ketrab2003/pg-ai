...
for _ in range(generations):
    ...
    selected_parents = random.choices(population, k=n_selection, weights=weights)
    ...
    for child in children:
        ...
        child[mutated_gene] = not child[mutated_gene]

    # 4. Update population
    selected_survivors = random.choices(population, k=population_size-len(children), weights=weights)
    population = children + selected_survivors
